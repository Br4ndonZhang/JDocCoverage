...
//    int linkCount;
    ...
    void addCommentWords(String comment) {
        commentWordsCount += countComment(comment);
    }

    void addCodeWords(String code) {
        codeWordsCount += code.length();
    }
    ...
    public void accumulate(CoverageResult result) {
        commentWordsCount += result.commentWordsCount;
        codeWordsCount += result.codeWordsCount;
